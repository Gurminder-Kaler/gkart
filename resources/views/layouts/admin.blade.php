...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="#"><p style="font-size: 45px;padding: 5px">GKart [ADMIN DASHBOARD]</p></a>
        </div>
        <ul class="nav navbar-nav">
            <li class="active"><a href="{{url('home')}}"><span class="glyphicon glyphicon-home"></span> Admin Home</a></li>
            <li><a href="{{url('/')}}"><span class="glyphicon glyphicon-home"></span> Non Admin Home</a></li>
            <li class="dropdown">
            ...
            <li><a href="{{url('/logout')}}"><span class="glyphicon glyphicon-off"></span> Logout From admin</a></li>
