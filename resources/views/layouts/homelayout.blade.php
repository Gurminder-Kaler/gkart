...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="dropdown-menu">
                    ...
                    @if (Auth::check())
                        @if(Auth::user()->isAdmin())
                            ...
                            <li><a class="bg-danger" href="{{url('admin')}}">GOTO Dashboard</a></li>
                        @else
            ...
            <li>
                @if(Auth::check())
                    <p class="pull-right" style="padding:5px;background:#1f648b;color: #fff;font-size: 25px">Welcome, {{Auth::user()->name}}</p>
                @endif
            </li>
        </ul>
    </div>
...
<br>
<div class="container" id="slidefix">
    <div class="row">
        <div class="col-md-12">
            <div id="myCarousel" style="padding: -51px" class="carousel slide " data-ride="carousel">
                <!-- Indicators -->
